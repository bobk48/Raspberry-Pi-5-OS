...
Notes:
0. If you want to run the Trixie version of the Raspberry Pi OS,
   ...
   between the Bookworm version and the Trixie version.
1. Section 1.2.4 works exactly as shown in the Trixie version of
   the Raspberry Pi OS. In step 4.d. on page 50, the reboot then
   happens from the uninitialized NVMe device, so you have to go
   through the steps to setup the system on the NVMe.
2. The website for this book at Taylor & Francis is as follows-
...
4. I also added all of the In-Chapter Exercise solutions, as the following-
