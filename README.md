...
7. The inxi command (with options) on the Debian Trixie Raspberry Pi OS
...
5. In Chapter 3, whenever you're using Way 3 (Import Script Mode)
   you must remember to give execute privilege to the file you are
   going to import into Python3 with the command:
   chmod u+x filename 

4. Section 1.2.4 works exactly as shown in the Trixie version of
...
2. I've added all of the Python 3 code examples, they're in the file

py_code.zip

1. I added all of the In-Chapter Exercise solutions, as the following-
